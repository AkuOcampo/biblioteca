...
public class LibroControlador {
    ...
    public String registro(@RequestParam(required=false) Long isbn, @RequestParam String titulo,
        ...
        try {
            libroS.crearLibro(isbn, titulo, ejemplares, idAutor, idEditorial);
    ...
    public String listar(ModelMap modelo) {
        List<Libro> libros = libroS.listarLibros();
    ...
    public String modificar(@PathVariable Long isbn, ModelMap modelo) {
        ...
        modelo.put("libro", libroS.getOne(isbn));
    ...
    public String modificar(@PathVariable Long isbn, String titulo, Integer ejemplares, String idAutor, String idEditorial, ModelMap modelo) {
        try {
            ...
            libroS.modificarLibro(isbn, titulo, idAutor, idEditorial,ejemplares);
